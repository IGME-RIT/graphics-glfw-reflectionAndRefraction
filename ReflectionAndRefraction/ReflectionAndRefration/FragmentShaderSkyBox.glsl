...
File Name: FragmentShaderSkyBox.glsl
Copyright © 2015
...
{	
	//Sample the cubemap
	vec4 reflectColor = texture(CubeMapTex, texCoord);
	out_color = (reflectColor);// Set our out_color equal to our in color, basically making this a pass-through shader.
}